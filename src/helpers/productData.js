        ...
        products: [
            ...
            },
            {
                ...
                application: [
                    ...
                    { application: "PA / ABS", icon: "checkmark" },
                    { application: "Nylon 6", icon: "outline" },
                    { application: "PBT / PET", icon: "outline" },
                    { application: "PP Fiber", icon: "checkmark" }
                ],
        ...
        products: [
            {
                ...
                use: ["Suitable", "Potential use"],
                meta: {
                    title: "KPL Blue 7000 U – Stabilized Copper Phthalocyanine Blue Pigment | Kesar Petroproducts Ltd.",
                    description:
        ...
        products: [
            {
                ...
                application: [{ application: "Corrosion-Resistant Coatings", icon: "checkmark" },
                { application: "Dental Cement", icon: "checkmark" },
                { application: "Industrial Applications", icon: "checkmark" },
                { application: "Pigments", icon: "checkmark" }],
                shades: ["#FFFFFF"],
                msds: 'https://cdn.kesarpetroproducts.com/msds-tds/MSDS/MSDS Anti Corrosives/MSDS KPL Zinc Phosphate.pdf',
                tds: 'https://cdn.kesarpetroproducts.com/msds-tds/TDS/Anti Corrosives/TDS KPL Zinc Phosphate.pdf',
                style: "center",
                category: "Anti Corrosives",
                use: ["Suitable", "Potential use"],
                meta: {
            ...
            },
            {
                ...
                application: [{ application: "Cosmetics and Skincare", icon: "checkmark" },
                { application: "Paints and Coatings", icon: "checkmark" },
                { application: "Rubber Industry", icon: "checkmark" },
                { application: "Ceramics and Glass", icon: "checkmark" },
                { application: "Pharmaceuticals", icon: "checkmark" },
                { application: "Electronics", icon: "checkmark" },
                { application: "Agriculture", icon: "checkmark" }],
                shades: ["#FFFFFF"],
                msds: 'https://cdn.kesarpetroproducts.com/msds-tds/MSDS/MSDS Anti Corrosives/MSDS KPL Zinc Oxide.pdf',
                tds: 'https://cdn.kesarpetroproducts.com/msds-tds/TDS/Anti Corrosives/TDS KPL Zinc Oxide.pdf',
                style: "center",
                category: "Anti Corrosives",
                use: ["Suitable", "Potential use"],
                meta: {
            ...
            },
            {
                ...
                { application: "Rubber Industry", icon: "checkmark" },
                { application: "Pharmaceuticals", icon: "checkmark" },
                { application: "Pigments and Coatings", icon: "checkmark" },
                { application: "Chemical Synthesis", icon: "checkmark" },
                { application: "Agriculture", icon: "checkmark" }],
                shades: ["#FFFFFF"],
                msds: 'https://cdn.kesarpetroproducts.com/msds-tds/MSDS/MSDS Anti Corrosives/MSDS KPL Zinc Carbonate.pdf',
                tds: 'https://cdn.kesarpetroproducts.com/msds-tds/TDS/Anti Corrosives/TDS KPL Zinc Carbonate.pdf',
                style: "center",
                category: "Anti Corrosives",
                use: ["Suitable", "Potential use"],
                meta: {
        ...
        products: [
            {
                ...
                application: [{ application: "Fertilizers", icon: "checkmark" },
                { application: "Fire Retardants", icon: "checkmark" },
                { application: "Food Industry", icon: "checkmark" },
                { application: "Industrial Applications", icon: "checkmark" },
                { application: "Chemical Synthesis", icon: "checkmark" }],
                shades: ["#FFFFFF"],
                msds: 'https://cdn.kesarpetroproducts.com/msds-tds/MSDS/MSDS Fertilizers/MSDS  Di-Ammonium Phosphate.pdf',
                tds: 'https://cdn.kesarpetroproducts.com/msds-tds/TDS/Fertilizers/TDS  Di-Ammonium Phosphate.pdf',
                style: "center",
                category: "Fertilizers",
                use: ["Suitable", "Potential use"],
                meta: {
            ...
            },
            {
                ...
                { application: "Food Industry", icon: "checkmark" },
                { application: "Industrial Applications", icon: "checkmark" },
                { application: "Analytical Chemistry", icon: "checkmark" }],
                shades: ["#FFFFFF"],
                msds: 'https://cdn.kesarpetroproducts.com/msds-tds/MSDS/MSDS Fertilizers/MSDS Mono-Ammonium Phosphate.pdf',
                tds: 'https://cdn.kesarpetroproducts.com/msds-tds/TDS/Fertilizers/TDS Mono-Ammonium Phosphate.pdf',
                style: "center",
                category: "Fertilizers",
                use: ["Suitable", "Potential use"],
                meta: {
            ...
            },
            {
                ...
                application: [{ application: "Agriculture", icon: "checkmark" },
                { application: "Animal Feed", icon: "checkmark" },
                { application: "Pharmaceuticals", icon: "checkmark" },
                { application: "Industrial Applications", icon: "checkmark" },
                { application: "Water Treatment", icon: "checkmark" },
                { application: "Chemical Synthesis", icon: "checkmark" }],
                shades: ["#FFFFFF"],
                msds: 'https://cdn.kesarpetroproducts.com/msds-tds/MSDS/MSDS Fertilizers/MSDS KPL Zinc Sulphate.pdf',
                tds: 'https://cdn.kesarpetroproducts.com/msds-tds/TDS/Fertilizers/TDS KPL Zinc Sulphate.pdf',
                style: "center",
                category: "Fertilizers",
                use: ["Suitable", "Potential use"],
                meta: {
